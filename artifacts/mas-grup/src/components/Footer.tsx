          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-white/70 text-sm">
                ...
                <a href="tel:+905336017622" className="hover:text-accent transition-colors">0533 601 76 22</a>
              </li>
              <li className="flex items-start gap-3 text-white/70 text-sm">
                <Mail className="w-5 h-5 text-accent shrink-0" />
                <a href="mailto:info@masgrupcleaning.com.tr" className="hover:text-accent transition-colors">info@masgrupcleaning.com.tr</a>
              </li>
              <li className="flex items-start gap-3 text-white/70 text-sm">
                ...
                <a href="https://wa.me/905336017622" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">533 601 76 22</a>
              </li>
              <li className="flex items-start gap-3 text-white/70 text-sm">
