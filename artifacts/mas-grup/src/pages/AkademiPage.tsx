  ...
  return (
    <div className="w-full overflow-hidden">
        ...
        <div className="relative z-10 px-8 md:px-16 max-w-5xl w-full" style={{ paddingTop: 72 }}>
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}
            ...
            <h1 className="text-white font-black leading-[1.02] tracking-tight mb-8"
              style={{ fontSize: "clamp(30px,8vw,116px)" }}>
              Temizliği<br />
          ...
          <div className="grid md:grid-cols-2 gap-px bg-primary/10">
            {modules.map((mod, i) => (
              ...
              >
                ...
                <div className="relative z-10 p-6 md:p-10 lg:p-14 min-h-[300px] flex flex-col justify-between">
      ...
      <section className="grid lg:grid-cols-2 min-h-[75vh]">
        ...
        <motion.div
          className="bg-white flex flex-col justify-center px-6 md:px-16 py-12 md:py-20"
          initial={{ opacity: 0, x: 40 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.9, ease: [0.16, 1, 0.3, 1] }}
